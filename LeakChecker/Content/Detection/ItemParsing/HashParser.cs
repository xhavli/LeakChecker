...
public static class HashParser
{
    ...
    public static async Task<(bool isHash, ItemEnum hashType)> TryParse(string token)
    {
        ...
        if (isHash)
        {
            ...
            ItemEnum hashType = MapHashType(hashName);
    ...
    private static ItemEnum MapHashType(string hashName)
    {
        // if (string.IsNullOrWhiteSpace(hashName))
        //     return ItemEnum.Null;

        string normalizedName = hashName.Trim().ToLowerInvariant();
        ...
        return normalizedName switch
        {
            ...
            // "bitcoin public address, bitcoin cash public address" => ItemEnum.BITCOIN_WIF_PRIVATE_KEY,
